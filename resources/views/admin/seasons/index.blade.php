...
<div class="body-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-2 d-flex align-items-center justify-content-end">
            <a href="{{ route('seasons.create') }}" class="btn btn-default mw-150" style="margin-top:-14px">Add Season</a>
        </div>
    </div>
    ...
    <div class="page-search mb-3">
        <div class="input-group">
            ...
            <input type="text" id="input_search" class="form-control" placeholder="Search Season" aria-label="Search" aria-describedby="basic-addon1">
        </div>
    </div>
        ...
        $(function() {
            var table = $('.channel-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'web_series_name',
                        name: 'web_series_name',
