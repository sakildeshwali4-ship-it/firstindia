...
@section('content')
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Episode {{ $episode->number }}</li>
                </ol>
            </div>
        ...
        <form method="post" action="{{ route('series.episodes.update', [$series, $episode]) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            @include('admin.reels.episodes.form', ['submitLabel' => 'Save Episode'])
        </form>
    </div>
@endsection
