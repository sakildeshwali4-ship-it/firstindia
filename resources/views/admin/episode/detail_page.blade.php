    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('episodes.video') }}">Video</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Details</li>
                </ol>
            </div>
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('episodes.video') }}" class="btn btn-default mw-150" style="margin-top: -14px;">Episode List</a>
            </div>
        </div>
        ...
        <div class="card custom-border-card">
            <table class="table table-striped table-hover table-bordered w-75 text-center" style="margin-left:auto; margin-right:auto">
                ...
                <thead>
                    <tr class="table-info">
                        <th colspan="2"> Episode Details </th>
                    </tr>
                </thead>

                <tbody>
                   <tr>
                        <td>Web Series Name</td>
                        <td>{{ $result->webseries->title ?? '-' }}</td>
                    </tr>

                    <tr>
                        <td>Season Name</td>
                        <td>{{ $result->season->title ?? '-' }}</td>
                    </tr>
                    ...
                    <tr>
                        <td>Warning Text</td>
                        <td>{{ isset($result->warning_text) ? $result->warning_text : "-" }}</td>
                    </tr> 
                    <tr>
                        <td>Warning Text Time</td>
                        <td>{{ isset($result->warning_text_start_time) ? $result->warning_text_start_time : "-" }} To {{ isset($result->warning_text_end_time) ? $result->warning_text_end_time : "None" }}</td>
                    </tr> 
                    <tr>
                        <td>Language</td>
                        <td>
                    ...
                    <tr>
                        <td>Likes</td>
                        <td>
                            {{ $result->is_like == 1 ? 'Enable' : 'Disable' }}
                        </td>
                    </tr> 
                    <tr>
                        <td>Dislikes</td>
                        <td>
                            {{ $result->is_dislike == 1 ? 'Enable' : 'Disable' }}
                        </td>
                    </tr>  
                    <tr>
                        <td>Superlikes</td>
                        <td>
                            {{ $result->is_superlike == 1 ? 'Enable' : 'Disable' }}
                        </td>
                    </tr>  
                    <tr>
                        <td>Wishlist</td>
                        <td>
                            {{ $result->wishlist == 1 ? 'Enable' : 'Disable' }}
                        </td>
                    </tr> 
                    <tr>
                        <td>Status</td>
