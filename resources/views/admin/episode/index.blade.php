...
{{ Request()->parameter }}
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                <a href="{{ route('episodes.videoAdd') }}" class="add-video-btn">
                ...
                <div class="card video-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="dropdown dropright">
                            ...
                            <i class="fa-solid fa-ellipsis fa-2xl dot-icon"></i>
                                <!-- <img src="{{ asset('assets/imgs/dot.png') }}" class="" /> -->
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="{{ route('episodes.videoDetail', ['id' => $value->id])}}">
                                <i class="fa-solid fa-eye fa-2xl dot-icon"></i>
                                    <!-- <img src="{{ asset('assets/imgs/eye.png') }}" class="dot-icon" /> -->
                                    {{__('Label.Details')}}
                                </a>
                                <a class="dropdown-item" href="{{ route('episodes.editVideo', array_merge(['id' => $value->id], $queryArray))}}">
                                <i class="fa-regular fa-pen-to-square fa-2xl dot-icon"></i>
                              
                                    <!-- <img src="{{ asset('assets/imgs/edit.png') }}" class="dot-icon" /> -->
                                    {{__('Label.Edit')}}
                                </a>
                                <a class="dropdown-item" href="{{ route('episodes.delete', ['id' => $value->id])}}" onclick="return confirm('Are you sure !!! You want to Delete this Video ?')">
