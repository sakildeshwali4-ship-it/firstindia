        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('episodes.video') }}">Episode</a>
                    </li>
            ...
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('episodes.video') }}" class="btn btn-default mw-120" style="margin-top:-14px">Episode List</a>
            </div>
        </div>

        <div class="card custom-border-card mt-3">
            <form enctype="multipart/form-data" id="save_episode" autocomplete="off">
                @csrf
                    ...
                    <div class="form-row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="webseries_id" id="webseries">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control  selectd2_1" style="width:100%!important;" name="language_id[]" id="language_id" multiple>
                                    ...
                                    <option {{ ($value->id == 1)?' selected':''}} value="{{ $value->id}}">
                                        {{ $value->name }}
                                    </option>
                                    @endforeach
                                </select>
                         ...
                         <div class="col-lg-6"> 
                            <div class="form-row">
                                ...
                                <div class="form-group skip_intro_fields ml-3">
                                    ...
                                    <input type="text" name="end_credit_time" id="intro_start" class="form-control" placeholder="mm:ss">
                                </div> 
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-3 video_box">
                            <!--<div style="display: block;">
                                ...
                                <div id="container" style="position: relative;">
                                    ...
                                    <div class="form-group">
                                        <a id="upload" class="btn text-white btn-default">{{__('Label.Upload Files')}}</a>
                                    </div>
                                </div>
                            </div>-->
                        </div>
                        <div class="form-group col-lg-3 video_box">
                            <div style="display: block;">
                                ...
                                <div id="container1" style="position: relative;">
                                    ...
                                    <div class="form-group">
                                        <a id="upload1" class="btn text-white btn-default">{{__('Label.Upload Files')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-lg-3 video_box">
                            <div style="display: block;">
                                ...
                                <div id="container2" style="position: relative;">
                                    ...
                                    <div class="form-group">
                                        <a id="upload2" class="btn text-white btn-default">{{__('Label.Upload Files')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="form-row custom-border-card">
            <div class="col-lg-6">
                <div class="row">
                    <div class="form-group col-lg-5">
                        <label>Warning Text</label>
                        <input name="warning_text" type="text" class="form-control" placeholder="Enter Warning Text">
                    </div>
                    <div class="form-group col-lg-3">
                        <label>Start Time</label>
                        <input type="text" name="warning_text_start" class="form-control" placeholder="mm:ss">
                    </div>

                    <div class="form-group col-lg-3">
                        <label>End Time</label>
                        <input type="text" name="warning_text_end" class="form-control" placeholder="mm:ss">
                    </div>
                </div>
            </div>
            <div class="col-lg-6"> 
                    <div class="form-row">
                        ...
                        <div class="form-group skip_fields ml-3">
                            ...
                            <input type="text" name="skip_start" id="skip_start" class="form-control" placeholder="mm:ss">
                        </div>

                        <div class="form-group skip_fields">
                            <label>Skip End Time (mm:ss)</label>
                            <input type="text" name="skip_end" id="skip_end" class="form-control" placeholder="mm:ss">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group col-lg-6 trailer_box">
                            <div style="display: block;">
                                ...
                                <div id="container5" style="position: relative;">
                                    ...
                                    <div class="form-group">
                                        <a id="upload5" class="btn text-white btn-default">{{__('Label.Upload Files')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function save_episode() {
            ...
            if(Check_Admin == 1){
                ...
                var formData = new FormData($("#save_episode")[0]);
                $("#dvloader").show();
                $.ajax({
                    type: 'POST',
                    ...
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_episode', '{{ route("episodes.video") }}');
                    },
