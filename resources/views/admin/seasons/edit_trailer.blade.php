...
@section('title', "Season Trailer Edit")
    ...
    <div class="row">
        <div class="col-sm-10">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Season Trailer Edit</li>
            </ol>
        </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="isActive">
                            <option value="0" {{ $result->status == 0 ? 'selected' : '' }}>No</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number"
                            name="trailer_number"
                            class="form-control"
                            value="{{ old('trailer_number', $result->trailer_number) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="url"
                            name="video_url"
                            class="form-control"
                            value="{{ old('video_url', $result->video_url) }}"
    ...
    if(Check_Admin == 1){
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                get_responce_message(resp, "update_season", "{{ route('seasons.trailers') }}");
            },
